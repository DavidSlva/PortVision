...
export const PortSelector: React.FC<PortSelectorProps> = ({ ports, selectedPortId, onPortSelect, loading }) => {
    return (
        <div>
            <label htmlFor="port-select" className="block text-sm font-medium text-gray-700">
                Seleccionar Puerto
            </label>
            {loading ? (
